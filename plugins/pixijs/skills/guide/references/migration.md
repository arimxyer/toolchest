...
## Table of Contents
- [Mixing PixiJS and Three.js](#mixing-pixijs-and-threejs) — Shared WebGL context, render loop coordination
- [v8 Migration Guide](#v8-migration-guide) — Breaking changes, new package structure, async init, Graphics API overhaul, texture changes, shader changes, filters, ParticleContainer, deprecated features
